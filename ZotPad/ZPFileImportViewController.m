...
- (void)viewWillAppear:(BOOL)animated{
    ...
    UIImage* fileImage = [[ZPAttachmentThumbnailFactory instance] getFiletypeImageForURL:url height:self.view.frame.size.height width:self.view.frame.size.width];
